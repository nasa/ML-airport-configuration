...
# airport_config_prediction documentation build
...
from airport_config_prediction import __version__ as release

# -- Project information -----------------------------------------------------

project = "airport_config_prediction"
copyright = "2020, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "airport_config_predictiondoc"
...
latex_documents = [
    (
        master_doc,
        "airport_config_prediction.tex",
        "airport_config_prediction Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "airport_config_prediction",
        "Project airport_config_prediction codebase.",
        "Data-Science",
    )
]
